...
export class LayoutEngine {
    ...
    /**
     * @param {any} graph_json
     * @returns {any}
     */
    layout(graph_json) {
        const ret = wasm.layoutengine_layout(this.__wbg_ptr, graph_json);
        if (ret[2]) {
    ...
    static getVersion() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.layoutengine_getVersion();
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('graph_easy_layout_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
